    ...
    return (
        <div className="min-h-screen bg-[#0A0A0F] flex items-center justify-center px-4">
            <div className="text-center max-w-md">
                ...
                <h2 className="text-lg font-bold text-white mb-2">Employer dashboard failed to load</h2>
                <p className="text-sm text-zinc-400 mb-6">Please try again in a moment.</p>
