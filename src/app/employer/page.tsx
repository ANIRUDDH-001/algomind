                    ...
                    <form onSubmit={handleUpgrade} className="space-y-4 text-left">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-[var(--surface-1)] border border-white/10 rounded-lg px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        ...
                        <div>
                            <label htmlFor="inviteCode" className="block text-sm font-medium text-zinc-300 mb-1">
                                Invite Code
                            </label>
                            <input
                                id="inviteCode"
                        ...
                        >
                            {isUpgrading ? <div className="w-5 h-5 mr-2 rounded-full border-2 border-indigo-600 border-t-transparent animate-spin" /> : null}
                            Upgrade to Employer
                        </Button>
                    </form>
                </div>
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-x-hidden pb-20 md:pb-4">
            <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-20 lg:py-32">
                ...
                <div className="text-center mb-20 max-w-4xl mx-auto">
                    ...
                    <p className="text-xl sm:text-2xl text-zinc-300 mb-10 leading-relaxed">
                ...
                <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mt-24">
                    <div className="bg-[var(--surface-2)]/50 backdrop-blur-sm p-8 rounded-2xl border border-white/10 hover:border-blue-500/50 transition-colors group">
                    ...
                    <div className="bg-[var(--surface-2)]/50 backdrop-blur-sm p-8 rounded-2xl border border-white/10 hover:border-purple-500/50 transition-colors group">
