    ...
    return (
        <div className="min-h-screen bg-[#0A0A0F] flex items-center justify-center px-4">
            <div className="text-center max-w-md">
                ...
                <h2 className="text-lg font-bold text-white mb-2">Interview session interrupted</h2>
                <p className="text-sm text-zinc-400 mb-6">
                    The interview session encountered an error. Your progress may have been saved.
                </p>
