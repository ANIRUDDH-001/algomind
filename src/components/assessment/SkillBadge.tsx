        ...
        <AnimatePresence>
            {shown && (
                <motion.div
                    ...
                    className="flex items-center gap-3 bg-slate-900/90 backdrop-blur-xl border border-white/10 p-3 rounded-2xl shadow-2xl pointer-events-none"
                ...
                >
                    ...
                    <div>
                        <p className="text-[10px] uppercase tracking-tighter text-slate-400 font-black leading-none mb-1">
                            {definition.name}
                        </p>
