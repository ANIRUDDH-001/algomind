...
// : Deno is not defined in Next.js tsconfig
import { createClient } from 'https://esm.sh/@supabase/supabase-js@2';
// : Deno URL imports are not resolved by Next.js tsconfig
import { timingSafeEqual } from 'https://deno.land/std@0.208.0/crypto/timing_safe_equal.ts';
// : Deno modules cannot have .ts extensions in Next.js; this runs in Deno runtime
