...
- **Intelligent Fallback Chain**: DB routing → cross-tier fallback → legacy provider fallback → AWS Bedrock Claude (Haiku/Sonnet)
...
| **AWS Bedrock** | Claude Haiku 4.5, Sonnet 4.5/4.6 | Last-resort fallback (cross-region support) |
